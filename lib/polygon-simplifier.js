...
class PolygonSimplifier {
	...
	/**
	 * Removes the vertex with the smallest area from the polygon.
	 *
	 * @method simplify
	 */
	simplify() {
	...
	/**
	 * Returns vertices remaining in the polygon as a valid GeoJson coordinates
	 * array.
	 *
	 * @method toGeoJson
	 * @return {Array[]} - Array containing arrays of ordered vertex
	 *   coordinates, one for each ring.
	 */
	toGeoJson() {
		return this.rings.map((ring) => ring.toGeoJson());
	}
