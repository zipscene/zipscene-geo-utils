...
class RingSimplifier extends LinearRing {
	...
	/**
	 * Checks if the next simplify call would cause a self-intersection.
	 *
	...
	/**
	 * Reverts the simplifier to just before the first self-intersection in its
	 * history, then clears the removed vertex history.
	 *
	 * @method rewind
	 */
	rewind() {
