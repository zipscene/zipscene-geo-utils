...
// const DEFAULT_MAX_VERTICES = 1000;
const DEFAULT_MIN_VERTICES = 30;

module.exports = function(vertices, { maxVertices, minVertices = DEFAULT_MIN_VERTICES, maxError = DEFAULT_MAX_ERROR }) {
...
// while (
// 	(numVerticies <= maxVertices && maxError > totalError) &&
// 	(numVerticies > minVertices)
// ) {
// 	// first we remove the vertex with the smallest area
// 	let minArea = areaBSTree.getMinKey();
...
// 	areaBSTree.insert(createAreaId(prev.area, prev.id), prev.id);
//
// 	// update num verticies
// 	numVerticies = areaBSTree.getNumberOfKeys();
// 	totalError = totalAreaChanged / startingArea;
// }
